...
public class SongController {
    ...
    public String addInstrument(@ModelAttribute("createInstrumentDto") CreateInstrumentDto createInstrumentDto, Model model) {
        ...
        return "redirect:/instruments"; // Redirect to /songs
    }
    ...
    public String updateInstrumentForm(@PathVariable Long id, Model model) {

        Song song = songService.findSongById(id);

        model.addAttribute("song", song);

        return "update_instrument"; // Refers to update_song.html (view)
    }

    @PutMapping("/{id}")
    public String updateInstrument(@PathVariable Long id, Model model, @ModelAttribute("createInstrumentDto") CreateInstrumentDto createInstrumentDto){
